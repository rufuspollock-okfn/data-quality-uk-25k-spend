...
xlsheet.col(1).width = 256 * 36
xlsheet.col(2).width = 256 * 64
xlsheet.col(3).width = 256 * 24
xlsheet.col(4).width = 256 * 36
xlsheet.col(5).width = 256 * 96
xlsheet.col(6).width = 256 * 96

xlsheet.write(0, 0, 'ID', bold_style)
xlsheet.write(0, 1, 'Name', bold_style)
xlsheet.write(0, 2, 'Title', bold_style)
xlsheet.write(0, 3, 'Type', bold_style)
xlsheet.write(0, 4, 'Parent', bold_style)
xlsheet.write(0, 5, 'Homepage', bold_style)
xlsheet.write(0, 6, 'Homepage for spending files', bold_style)
